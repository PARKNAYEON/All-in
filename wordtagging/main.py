...
#         f.write(data)
#
# with open('은어 및 주식 언어.csv','r') as f:
#     reader = csv.reader(f)
#
#     for a in reader:
#         if a[2] == '-1':
...
#         count += 1
#
# write_data(positive_data,'긍정_은어_감성사전.txt', encoding='UTF8')
# write_data(negative_data, '부정_은어_감성사전.txt', encoding='UTF8')
# write_data(neu_data,'중립_은어_감성사전.txt', encoding='UTF8')